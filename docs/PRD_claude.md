...
| F-MAP-06 | P0 | **Mapping** = name, enabled flag, trigger (F-THOR-07/08 or F-MQTT-03 or a UI event), one or more actions (`activateScene`, `releaseScene`, `releaseLayer`, `blackout on/off`, `setLevel`, `publishMqtt`, `thoriumMutation`), optional simulator restriction, optional debounce ms, notes. |
